...
__doc__ = HeaderBuilder.build(
    ...
    module_title="ToolKit Utilities",

    module_description=(
        "Module responsible for defining different computational bioinformatics utilities, "
        "handles for file manipulation, molecule conversion, and exploration."
    ),
